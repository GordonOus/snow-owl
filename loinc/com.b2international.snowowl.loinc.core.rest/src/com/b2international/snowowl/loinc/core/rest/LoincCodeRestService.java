...
import com.b2international.snowowl.loinc.core.rest.domain.LoincCodeRestSearch;
...
/**
 * REST service for LOINC codes.
 *
 * @since 9.9
 */
@Tag(description = "LOINC Codes", name = "LoincCodes")
@Controller
@RequestMapping(value = "/{path:**}/loinc/codes")
public class LoincCodeRestService extends AbstractRestService {

	public LoincCodeRestService() {
	...
	@Operation(
		summary = "Retrieve LOINC codes",
		description = "Returns a list with all/filtered LOINC codes from a path."
	)
	@ApiResponses({
	...
	public @ResponseBody Promise<LoincCodes> searchByGet(
			@Parameter(description = "The resource path", required = true)
			@PathVariable(value = "path")
			final String path,

			@ParameterObject
			final LoincCodeRestSearch params,
		...
		return LoincRequests
				.prepareSearchLoincCode()
				.setLimit(params.getLimit())
				.setSearchAfter(params.getSearchAfter())
				.filterByIds(params.getId())
				.filterByActive(params.getActive())
				.filterByStatus(params.getStatus())
				.filterByLoincNums(params.getLoincNum())
				.filterByComponent(params.getComponent())
				.filterByProperty(params.getProperty())
				.filterByScaleTyps(params.getScaleTyp())
				.filterByClassTypes(params.getClassType())
				.filterByOrderObs(params.getOrderObs())
				.filterBySearchText(params.getSearchText())
	...
	public @ResponseBody Promise<LoincCodes> searchByPost(
			@Parameter(description = "The resource path", required = true)
			@PathVariable(value = "path")
			final String path,
