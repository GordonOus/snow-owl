...
/**
 * A pageable collection of LOINC codes.
 *
 * @see LoincCode
 * @since 9.9
 */
public final class LoincCodes extends PageableCollectionResource<LoincCode> {

	private static final long serialVersionUID = 1L;

	/**
	 * Instantiates an empty pageable collection for LOINC codes.
	 *
	 * @param limit - limit of items for a single page
	 * @param total - total number of items in the resultset
	 */
	public LoincCodes(int limit, int total) {
		super(Collections.emptyList(), null, limit, total);
	}

	/**
	 * Instantiates a pageable collection of LOINC codes.
	 *
	 * @param items       - list of {@link LoincCode}s
	...
	@JsonCreator
	public LoincCodes(
			@JsonProperty("items") List<LoincCode> items,
